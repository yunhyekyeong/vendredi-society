...
!(function (t, e) {
  ...
  function a(t, e, n) {
    ...
    return (
      o(t) &&
        ((r = t[a.expando] || (t[a.expando] = ++a.uid)),
  ...
  function u(t) {
    var e = t && t[a.expando];
    e && (delete t[e], delete a.cache[e]);
  }
  function f(t, e) {
    for (var n = r(t), i = n.length, o = 0; o < i; o++) e(n[o], o, n);
  }
  (a.expando = "splitType".concat(1 * new Date())), (a.cache = {}), (a.uid = 0);
  var d = "\\ud800-\\udfff",
    h = "\\u0300-\\u036f\\ufe20-\\ufe23",
    p = "\\u20d0-\\u20f0",
    y = "\\ufe0e\\ufe0f",
  ...
  function B(t, e) {
    var i,
      ...
      s = e.tagName,
      l = "B".concat(1 * new Date(), "R"),
      u = "absolute" === e.position || e.absolute,
      d = [],
      h = [];
    if (
      ((o = r.lines ? D("div") : P()),
      ...
      ).reduce(function (t, n, i, a) {
        var u, d;
        return n === l
          ? (o.appendChild(D("br")), t)
          : (r.chars &&
              ((d = (function (t) {
                var e =
    ...
    var p,
      ...
      w = [],
      b = [],
      C = a(t, "nodes", t.getElementsByTagName(s)),
      x = t.parentElement,
      T = t.nextElementSibling,
      E = window.getComputedStyle(t).textAlign;
    return (
      u &&
        ((m = { left: o.offsetLeft, top: o.offsetTop, width: o.offsetWidth }),
        (g = t.offsetWidth),
        (y = t.offsetHeight),
      ...
      u &&
        ((t.style.width = "".concat(t.style.width || g, "px")),
      ...
      { lines: d, words: r.words ? i : [], chars: h }
    );
  }
  var R = n(N, {});
  return (function () {
